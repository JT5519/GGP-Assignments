...
void Game::CreateMaterials()
{
	...
	materials.push_back(std::make_shared<Material>(DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f), 0.0f, vertexShader, pixelShader)); //all 3 shiny white materials
	materials.push_back(std::make_shared<Material>(DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f), 0.0f, vertexShader, pixelShader)); 
	materials.push_back(std::make_shared<Material>(DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f), 0.0f, vertexShader, pixelShader)); 
}
...
void Game::UpdateLights()
{
	...
	//Direction Light 1 color
	{
		...
		if (ImGui::DragFloat3("Direction Light (1,0,0) Color", &color.x))
		{
	...
	//Direction Light 2 color
	{
		...
		if (ImGui::DragFloat3("Direction Light (0,-1,0) Color", &color.x))
		{
	...
	//Direction Light 3 color
	{
		...
		if (ImGui::DragFloat3("Direction Light (0,0,1) Color", &color.x))
		{
...
void Game::Draw(float deltaTime, float totalTime)
{
	...
	{
		entity->GetMaterial()->GetPixelShader()->SetFloat3("ambientTerm", mainCamera->GetAmbientColor());
